 ...
 *
 * @module     local_nexreports/course_completion
...
define(['core/ajax', 'local_nexreports/table_export'], function(Ajax, TableExport) {
    ...
    const init = function(cfg) {
        cfg = cfg || {};
        const root = document.querySelector('[data-region="nxr-course-completion"]');
        if (!root) {
            return;
        }
        ...
        const load = function(opts) {
            ...
            Ajax.call([{
                methodname: 'local_nexreports_get_course_completion',
                args: {
                    courseid: courseid,
                    cohortid: 0,
                    groupid: 0,
