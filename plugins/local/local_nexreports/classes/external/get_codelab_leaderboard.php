...
/**
 * AJAX: NexCodeLab leaderboard report.
 *
...
use local_nexreports\local\codelab_report;

/**
 * NexCodeLab tab — XP, missions completed, and challenge solves.
 */
class get_codelab_leaderboard extends external_api {
    ...
    public static function execute(
        ...
        return codelab_report::leaderboard(
            (int) $params['cohortid'],
    ...
    public static function execute_returns(): external_single_structure {
        ...
        $row = new external_single_structure([
            ...
            'codelabUrl' => new external_value(PARAM_URL, 'CodeLab leaderboard URL'),
            'lastaccess' => new external_value(PARAM_TEXT, 'Last access'),
            'xp' => new external_value(PARAM_INT, 'CodeLab XP'),
            'missionscompleted' => new external_value(PARAM_INT, 'Missions completed'),
            'missionsstarted' => new external_value(PARAM_INT, 'Missions started'),
            'solved' => new external_value(PARAM_INT, 'Challenges solved'),
            'streak' => new external_value(PARAM_INT, 'Current streak'),
            'longest' => new external_value(PARAM_INT, 'Longest streak'),
            'attempts' => new external_value(PARAM_INT, 'Challenge submissions'),
            'lastactivity' => new external_value(PARAM_TEXT, 'Last CodeLab activity'),
        ]);
        return new external_single_structure([
            'generated' => new external_value(PARAM_INT, 'Generated'),
            'rows' => new external_multiple_structure($row),
            'summary' => new external_single_structure([
                'activelearners' => new external_value(PARAM_INT, 'Active learners'),
                'totalxp' => new external_value(PARAM_INT, 'Total XP'),
                'missionscompleted' => new external_value(PARAM_INT, 'Missions completed'),
                'totalsubmissions' => new external_value(PARAM_INT, 'Challenge submissions'),
                'publishedmissions' => new external_value(PARAM_INT, 'Published missions'),
            ]),
