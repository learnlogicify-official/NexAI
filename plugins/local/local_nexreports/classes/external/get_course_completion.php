 ...
 */
class get_course_completion extends external_api {
    ...
    public static function execute(
        ...
        return courses_report::course_completion(
            (int) $params['courseid'],
            0,
            0,
    ...
    public static function execute_returns(): external_single_structure {
        $row = new external_single_structure([
            ...
            'codingsolved' => new external_value(PARAM_INT, 'CodeRunner questions solved', VALUE_OPTIONAL),
            'codingattempted' => new external_value(PARAM_INT, 'CodeRunner questions attempted', VALUE_OPTIONAL),
            'codingtotal' => new external_value(PARAM_INT, 'CodeRunner questions in course', VALUE_OPTIONAL),
