...
/**
 * NexBattleGround reports tab — wins, win rate, and battle XP.
 *
...
$PAGE->set_url(new moodle_url('/local/nexreports/nexbattleground.php'));
$PAGE->set_context($context);
$PAGE->set_title(get_string('nexbattleground', 'local_nexreports'));
...
$PAGE->requires->js_call_amd('local_nexreports/nexbattleground', 'init', []);

$shell = local_nexreports_shell_context('nexbattleground');
$exporturl = (new moodle_url('/local/nexreports/download.php', [
    'report' => 'battle_leaderboard',
    'format' => 'csv',
]))->out(false);

echo $OUTPUT->header();
echo $OUTPUT->render_from_template('local_nexreports/nexbattleground', array_merge($shell, [
    'exporturl' => $exporturl,
    'showperiod' => false,
    'showcollege' => true,
    'showdepartment' => true,
