...
/**
 * Section output for format_nexcourse (align with topics for editor controls).
 *
...
/**
 * Section output — core template + add-section controls like topics.
 */
class section extends section_base {
    ...
    public function export_for_template(renderer_base $output): stdClass {
        ...
        // Match topics: show "add section" after top-level sections on the course page.
